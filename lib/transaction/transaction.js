...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://bgrade.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by bgrade:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a bgrade Address object. The
 * same is true for `script`, which can be a string or a bgrade Script.
 *
